...
public class Piece {
	...
	public void start () {
		...
		if (piece == true) {
			...
			System.out.println("You should have a piece.");
		}
	}
	...
	public void setName(String name) {
		if (name == "King" || name == "king") {
			...
			System.out.println("There is only one piece: King.");
		}
	}
	...
	public void setPiecePlace(int a, int b) {
		...
		} else if (existence == true && piece == true) {
			System.out.println("You should start a game, before moving a piece.");
		} else {
			System.out.println("You should have a correct piece before moving it.");
		}
	}
